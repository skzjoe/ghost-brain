...
2) **Short-horizon focus**
   - If `memory/now.md` exists, read it first and treat it as the compact 24–72 hour execution lens.
   - Use it to align the briefing with the most current priorities, blockers, and waiting items before scanning broader sources.
...
4) **Follow-ups & Commitments check**
