...
check "ghost_conversation_memory.py" "[[ -f '$WORKSPACE/scripts/ghost_conversation_memory.py' ]]"
check "ghost_guardrails.py" "[[ -f '$WORKSPACE/scripts/ghost_guardrails.py' ]]"
check "ghost_memory_sync.py" "[[ -f '$WORKSPACE/scripts/ghost_memory_sync.py' ]]"
